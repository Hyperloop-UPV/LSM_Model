...
MAKECMD         = /usr/local/MATLAB/R2026a/bin/glnxa64/gmake -j 8 -l 10
HOST            = UNIX
BUILD           = yes
SYS_TARGET_FILE = any
...
MODEL                   = Subsystem
MODULES                 = Subsystem_sf.c Subsystem_sf_data.c c_mexapi_version.c
PRODUCT                 = $(RELATIVE_PATH_TO_ANCHOR)/Subsystem_sf.mexa64
MAKEFILE                = Subsystem.mk
MATLAB_ROOT             = /usr/local/MATLAB/R2026a
ALT_MATLAB_ROOT         = /usr/local/MATLAB/R2026a
...
COMPILE_FLAGS_OTHER     = -msse2 -fno-predictive-commoning -Wno-implicit-function-declaration
SYSTEM_LIBS             = -L"/usr/local/MATLAB/R2026a/bin/glnxa64" -lut -lfixedpoint -lmx -lmex
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/Subsystem_sfcn_rtw \
...
Subsystem_sf.o : $(START_DIR)/Subsystem_sfcn_rtw/Subsystem_sf.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) $(START_DIR)/Subsystem_sfcn_rtw/Subsystem_sf.c

Subsystem_sf_data.o : $(START_DIR)/Subsystem_sfcn_rtw/Subsystem_sf_data.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) $(START_DIR)/Subsystem_sfcn_rtw/Subsystem_sf_data.c
