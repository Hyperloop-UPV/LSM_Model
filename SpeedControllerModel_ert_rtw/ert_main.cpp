...
#include "SpeedControllerModel.h"      // Model header file

static SpeedController SpeedControllerModel_Obj;// Instance of model class
...
void rt_OneStep(void)
{
  ...
  // Step the model
  arg_Iq_ref = SpeedControllerModel_Obj.step(arg_Speed_ref, arg_Real_Speed);
...
int main(int argc, const char *argv[])
{
  ...
  // Initialize model
  SpeedControllerModel_Obj.initialize();
  ...
  // Terminate model
  SpeedControllerModel_Obj.terminate();
  return 0;
}
