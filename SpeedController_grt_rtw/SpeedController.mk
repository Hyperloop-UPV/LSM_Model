###########################################################################
## Makefile generated for component 'SpeedController'. 
## 
## Makefile     : SpeedController.mk
## Generated on : Wed Jun 10 11:49:53 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/SpeedController
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/SpeedController
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/SpeedController_grt_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
...
DEFINES_STANDARD = -DMODEL=SpeedController -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(MATLAB_ROOT)/rtw/c/src/rt_logging.c $(START_DIR)/SpeedController_grt_rtw/SpeedController.cpp $(START_DIR)/SpeedController_grt_rtw/rt_nonfinite.cpp
...
OBJS = rt_logging.o SpeedController.o rt_nonfinite.o
...
%.o : $(START_DIR)/SpeedController_grt_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/SpeedController_grt_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/SpeedController_grt_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/SpeedController_grt_rtw/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/SpeedController_grt_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
SpeedController.o : $(START_DIR)/SpeedController_grt_rtw/SpeedController.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


rt_nonfinite.o : $(START_DIR)/SpeedController_grt_rtw/rt_nonfinite.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
